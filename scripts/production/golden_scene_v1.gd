...
func _runtime_content_checks(image_size: Vector2i, image_metrics: Dictionary) -> Dictionary:
	return {
		...
		"coherent_real_asset_town": world.town_instance_count >= 10,
		"forest_and_treelines": world.tree_instance_count >= 40,
		...
		"explosions": vfx.explosion_count >= 2,
		"tracer_and_shell_trajectories": vfx.tracer_segment_count >= 4,
		"impact_dust": vfx.impact_count >= 4,
		"muzzle_flash": vfx.muzzle_flash_count >= 2,
