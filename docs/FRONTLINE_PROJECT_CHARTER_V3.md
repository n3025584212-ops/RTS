...
For practical multi-chat work, FRONTLINE may use four stable GPT conversation/routing labels under `docs/GPT_MULTI_WINDOW_SYSTEM_V3.md`:
...
`docs/GPT_MULTI_WINDOW_SYSTEM_V3.md`, `docs/GPT_WINDOW_RUNTIME_PLAN_V2.md` and `docs/gpt_windows/` define collaboration/routing behavior but do not create additional project truth.
