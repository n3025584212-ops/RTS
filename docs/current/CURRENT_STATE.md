...
ACTIVE_BRANCH_VERIFIED_HEAD=394460d
...
NEXT=WINDOW_00_DEFINE_NEXT_PRODUCT_GATE (Gate A/B/C slice closed; first high-fidelity slice with real gameplay accepted)
NEXT_AFTER_FRESH_PRODUCT_RUNTIME=WINDOW_03_INDEPENDENT_PLAYER_VISUAL_AUDIT (done for Gate B; repeat per future gate)
