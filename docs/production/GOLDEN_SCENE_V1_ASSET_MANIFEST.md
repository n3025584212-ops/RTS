...
| Main battle tank | Heathal “Tank”, OpenGameArt | https://opengameart.org/content/tank-3 | CC0 1.0 | YES | YES | Blender .blend | Blender headless export to GLB; Godot GLB import | Converted only; duplicated as multiple physical MBTs with tactical overlays |
...
| Terrain / water / bridge / roads / fields | FRONTLINE project-authored Golden Scene geometry and shaders | repository source | Project source | YES | YES under repository terms | GDScript-generated ArrayMesh / ShaderMaterial | Native Godot | Sculpted terrain, shaded river, multi-member bridge, roads, fields, atmospheric/PBR materials |
