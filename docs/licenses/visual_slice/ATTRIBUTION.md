...
The distant church is the repository's existing derivative of Daniel Andersson's CC0 Medieval Church, as documented in `docs/production/GOLDEN_SCENE_V1_ASSET_MANIFEST.md`. Native architecture, terrain, grass geometry, shaders, composition and asset preparation scripts are authored for this project.
